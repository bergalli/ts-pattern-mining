...
# midas_forecaster documentation build
...
from midas_forecaster import __version__ as release

# -- Project information -----------------------------------------------------

project = "midas_forecaster"
author = "Kedro"
...
htmlhelp_basename = "midas_forecasterdoc"
...
latex_documents = [
    (
        master_doc,
        "midas_forecaster.tex",
        "midas_forecaster Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "midas_forecaster",
        "Project midas_forecaster codebase.",
        "Data-Science",
    )
]
